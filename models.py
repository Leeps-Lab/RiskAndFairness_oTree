...
class Player(BasePlayer):
    ...
    cq_failed_attempts = models.IntegerField(widget=widgets.HiddenInput(attrs={'id': 'attempts'}))
    cq_a1 = models.StringField(widget=widgets.HiddenInput(attrs={'id': 'a1'}))
    cq_a2 = models.StringField(widget=widgets.HiddenInput(attrs={'id': 'a2'}))
